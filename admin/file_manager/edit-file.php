                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    <div><img src="<?php echo "../img/" . $data['filelink'] ?>" alt="no" height="100px"
                                            width="100px"></div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Image</label>

                                        <input type="file" class="form-control" id="exampleInputEmail1" name="dataFile"
                                            aria-describedby="emailHelp" value="<?php echo $data['filelink']; ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1"
                                            name="description" value=""><?php echo $data['description']; ?></textarea>
                                    </div>
                                </div>
