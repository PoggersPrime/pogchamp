                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">S.N</th>
                                    <th scope="col">top_title</th>
                                    <th scope="col">top_desc</th>
                                    <th scope="col">img</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm "
                                            href="edit-aboutus.php?id=<?php echo $data['id']; ?>" role="button">Edit
                                        </a>
                                        <a class="btn btn-info btn-sm "
                                            href="view-aboutus.php?id=<?php echo $data['id']; ?>" role="button">View
                                        </a>
                                        <a class="btn btn-danger btn-sm "
                                            href="../process/delete-aboutus.php?id=<?php echo $data['id']; ?>"
