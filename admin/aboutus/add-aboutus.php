                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if ($img !== "" && $title !== "" && $description !== "") {
                                $query = "INSERT INTO aboutus(top_title,top_desc,img,title,description) VALUES (' $top_title',' $top_desc','$img','$title','$description')";
                            ...
                            <div class="row">
                                <div class="row">
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="top_title">
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-6">
                                        <label for="exampleInputEmail1" class="form-label">Top_desc</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="top_desc">
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-6">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            ?>
                                                                <label>
                                                                    ...
                                                                    <img src="<?php echo "../img/" . $data_select['filelink']; ?>" alt="" height="100px;" width="100px;" style="margin-right:20px;">
                                                                </label>
                                                            <?php
                                                            }
                                                            ?>
