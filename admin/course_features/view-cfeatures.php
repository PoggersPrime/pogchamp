...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>View course_features</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="../home.php">Home</a></li>
                    <li class="breadcrumb-item active">View Course features</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <section class="section">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">View Course_features</h5>
                        <a href="manage-cfeatures.php" class="btn btn-primary btn-md my-3 ">Back</a>
                        <?php
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
