            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            $edit = "SELECT* FROM testimonials where id=$id";
